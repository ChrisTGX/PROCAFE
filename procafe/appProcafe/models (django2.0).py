...
class Department(models.Model):
    unit_ID = models.ForeignKey(Unit, on_delete=models.CASCADE, verbose_name="Unidad de Adscripción", default=None)
...
class Section(models.Model):
    department_ID = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name="Dpto", default=True)
    name = models.CharField(max_length=200, verbose_name="Nombre")
    lower = models.CharField(max_length=200, unique=True, editable=False)
    sede = models.CharField(max_length=10, verbose_name="Sede", choices=[("SARTENEJAS", "Sartenejas"), ("LITORAL", "Litoral")], default="SARTENEJAS")
...
class UserProfile(models.Model):
    ...
    paysheet = models.ForeignKey(Paysheet, on_delete=models.CASCADE, verbose_name='Tipo de Nómina', default=None, null=True)
    type = models.ForeignKey(Type, on_delete=models.CASCADE, verbose_name='Tipo de Personal', default=None, null=True)
    location = models.ForeignKey(Location, on_delete=models.CASCADE, verbose_name='Ubicación', default=None, null=True)
    position = models.ForeignKey(Position, on_delete=models.CASCADE, verbose_name="Cargo", default=None, null=True)    
...
class Telephone(models.Model):
    user_ID = models.ForeignKey(UserProfile, on_delete=models.CASCADE, to_field='ID_number', verbose_name="Nombre de usuario", default=0)
...
class CourseRequest(models.Model):
    ProposedBy = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Propuesto por", editable=False)
    name = models.CharField(max_length=200, verbose_name="* Nombre", default=None)
    lower = models.CharField(max_length=200, unique=True, editable=False)
    description = models.CharField(max_length=200, verbose_name = "* Descripción", default=None)
    content = models.CharField(max_length=200, verbose_name="* Contenido", default=None)
...
class CourseChangeRequest(models.Model):
    ProposedBy = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Propuesto por", editable=False)
    cambiando = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name="cambiando", editable=False)#apuntador al curso que se debe cambiar
    name = models.CharField(max_length=200, verbose_name="* Nombre", default=None)
    lower = models.CharField(max_length=200, unique=True, editable=False)
    description = models.CharField(max_length=200, verbose_name = "* Descripción", default=None)
    content = models.CharField(max_length=200, verbose_name="* Contenido", default=None)
...
class Takes(models.Model):
    user_ID = models.ForeignKey(UserProfile, on_delete=models.CASCADE, verbose_name="Nombre", default=None)
    course_ID = models.ForeignKey(Course, on_delete=models.CASCADE, verbose_name="Curso", default=None)
...
class UserApplication(models.Model):
    ...
    paysheet = models.ForeignKey(Paysheet, on_delete=models.CASCADE, verbose_name='Tipo de Nómina', default=None)
    type = models.ForeignKey(Type, on_delete=models.CASCADE, verbose_name='Tipo de Personal', default=None)
    location = models.ForeignKey(Location, on_delete=models.CASCADE, verbose_name='Ubicación', default=None)
    position = models.ForeignKey(Position, on_delete=models.CASCADE, verbose_name="Cargo", default=None)
...
class RemoveRequest(models.Model):
    ID_number = models.ForeignKey(UserProfile, on_delete=models.CASCADE, to_field='ID_number', verbose_name="Cédula", default=0, related_name='ID_number_remove_reques')
    USB_ID = models.ForeignKey(UserProfile, on_delete=models.CASCADE, to_field='USB_ID', validators=[USBIDValidator], default=None, related_name='USB_ID_remove_reques')
